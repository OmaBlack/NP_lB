...
const ProjectFinancing = () => {
    return(<div className={style.financing}>
    ...
    <div className={style.details}>
        ...
        <section className={style.section_flex}>
            <p className={style.first}>Your credit request has been submitted successfully!</p>
            <p className={style.second}>#82937090</p>
            <p className={style.third}>Your credit request will go through our review process. Once all the information provided has been validated, a nerve link will be sent to the vendor, and you will recieve an update on the status of your funds.</p>
