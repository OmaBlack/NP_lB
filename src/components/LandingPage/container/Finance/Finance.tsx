          ...
          <div className={FinanceStyles.financebox}>
            ...
            <div className={FinanceStyles.finance_text}>
                ...
                <div className={FinanceStyles.financebtn}>
                    <button><span className={FinanceStyles.span1}><Link to="#">Get a loan today!</Link></span></button>
                    <button><span className={FinanceStyles.span2}><Link to="#">Learn More</Link></span></button>
                </div>
            </div>
        </div> 
      </section>
