  ...
  return (
    <>
      ...
      <div className={HistoryStyle.container}>
        ...
        <div className={HistoryStyle.sortfilter}>
          <div className={HistoryStyle.sortfilter_items}>
            <img src={sidelines} alt="three lines icon" />
            <span>SORT</span>
            <img src={centerlines} alt="three lines icon" />
            <span>FILTER</span>
          </div>
        </div>
        ...
        <div className={HistoryStyle.contentlist}>
          <div className={HistoryStyle.headrow}>
            <p className={HistoryStyle.request}>
              <span>REQUEST</span>
            </p>
            <p className={HistoryStyle.purpose}>
              <span>PURPOSE</span>
            </p>
            <p className={HistoryStyle.amount}>
              <span>AMOUNT REQUESTED</span>
            </p>
            <img src={blockdown} className={HistoryStyle.amtbtn} alt="icon" />
            <p className={HistoryStyle.date}>
              <span>DUE DATE</span>{" "}
            </p>
            <img src={blockdown} className={HistoryStyle.datebtn} alt="icon" />
            <p className={HistoryStyle.priority}>
              <span>PRIORITY </span>
            </p>
            <img
              src={blockdown}
              className={HistoryStyle.prioritybtn}
              alt="icon"
            />
            <p className={HistoryStyle.status}>
              <span>STATUS</span>
            </p>
            <img
              src={blockdown}
              className={HistoryStyle.statusbtn}
              alt="icon"
            />
          </div>
          ...
          <div className={HistoryStyle.firstrow}>
            ...
            <p className={HistoryStyle.firstrow6}>
              <span>Approved</span>
            </p>
          </div>
          ...
          <div className={HistoryStyle.secondrow}>
            ...
            <p className={HistoryStyle.secondrow6}>
              <span>Rejected</span>
            </p>
          </div>
          ...
          <div className={HistoryStyle.thirdrow}>
            ...
            <p className={HistoryStyle.thirdrow6}>
              <span>Disbursed</span>
            </p>
          </div>
          ...
          <div className={HistoryStyle.fourthrow}>
            ...
            <p className={HistoryStyle.fourthrow6}>
          ...
          <div className={HistoryStyle.fifthrow}>
            ...
            <p className={HistoryStyle.fifthrow6}>
              <span>Rejected</span>
            </p>
          </div>
