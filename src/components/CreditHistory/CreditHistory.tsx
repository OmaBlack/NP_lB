     ...
     <div className={HistoryStyle.container}>
      ...
      <div className={HistoryStyle.sortfilter}>
          <div className={HistoryStyle.sortfilter_items}>
              <img src={sidelines} alt="three lines icon" /><span>SORT</span>
            <img src={centerlines} alt="three lines icon" /><span>FILTER</span>
          </div>
      </div>
      ...
      <div className={HistoryStyle.contentlist}>
        <div className={HistoryStyle.headrow}>
          ...
          <p className={HistoryStyle.status}><span>STATUS</span></p><img src={blockdown} className={HistoryStyle.statusbtn}alt="icon" />
        </div>
        ...
        <div className={HistoryStyle.firstrow}>
          ...
          <p className={HistoryStyle.firstrow6}><span>Approved</span></p>
        </div>
        ...
        <p className={HistoryStyle.secondrow6}><span>Rejected</span></p>
        </div>
        ...
        <p className={HistoryStyle.thirdrow6}><span>Disbursed</span></p>
        </div>
        ...
        <p className={HistoryStyle.fourthrow6}><span>Processing</span></p>
        </div>
        ...
        <p className={HistoryStyle.fifthrow6}><span>Rejected</span></p>
        </div>
      </div>
    </div> 
    </>
