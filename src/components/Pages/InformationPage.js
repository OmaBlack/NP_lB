 ...
 const SecondPageCentered = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            hospitalName: Yup.string().min(3, "Must not be less than 3").required("Required"),
            typeOfFacility: Yup.string("Please choose a facility").required("Required"),
            address: Yup.string().min(5,"Please insert a valid address").required("Required")
                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className="doubleInput">
                        ...
                        <div className="doubleInp">
                            {formik.touched.typeOfFacility && formik.errors.typeOfFacility?<p className="formik_error">
                            {formik.errors.typeOfFacility} </p>: null}
                    ...
                    <div className="Nex-Prev">
                        ...
                        <button
                            className="next"
                            type="submit"
                            onSubmit={formik.handleSubmit}> next
                        </button>
                    </div>
