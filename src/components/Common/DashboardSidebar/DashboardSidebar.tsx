        ...
        <ul>
          ...
          <li className={style.fund}>
            <Link to="#" className={style.linkimg}>
              ...
              />
              <span>Funding</span>
              <span className={style.btn} onClick={display}>
                {show ? (
                  <img src={Images.warrowup} alt="a white arrow" />
                ) : (
          ...
          {show && (
            <div className={style.child}>
              <Link to="/funding" className={style.linkchild}>
                <li>
                  <h2>Pay With Nerve</h2>
                </li>
              </Link>
              <Link to="/funding" className={style.linkchild}>
                <li>
              ...
              <Link to="#" className={style.linkchild}>
                <li>
